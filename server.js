...
Issuer.discover(argv.issuer).then(function(issuer) {
  var hostname = (process.env.HEROKU_APP_NAME ? process.env.HEROKU_APP_NAME + '.herokuapp.com' : 'portal.galvin.ninja:' + argv.port)
  ...
  httpServer.listen(argv.port, function() {
    ...
    const baseUrl   = address.address === '0.0.0.0' ?
            ...
            scheme + '://portal.galvin.ninja:' + address.port;
