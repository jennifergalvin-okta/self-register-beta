...
module.exports = function(issuer, client, authzParams) {
  ...
  function redirectUrlFor(req) {
    ...
    // Adding the ability to pluck a "RedirectUrl" argument from the redirect so the source can control the final destination
    if (req.query.RedirectUrl != null)
      { rv = urlencode.decode(req.query.RedirectUrl.trim()); }
